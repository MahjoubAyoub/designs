...
<template>
  <!-- Testimonials -->
  <div class="relative px-15 my-80">
    <div class="max-w-[85rem] mx-auto">
      ...
      <div v-else class="relative">
        ...
        <!-- Blockquote -->
        <blockquote
          class="text-center px-30 lg:mx-auto lg:w-3/5 transition-all duration-500 ease-in-out"
          @mouseenter="stopAutoRotation"
          @mouseleave="startAutoRotation"
        >
          <div class="relative mt-6 lg:mt-10">
            <BaseIcon
              name="Quote"
              size="40"
              class="absolute top-0 start-0 text-primary rotate-180 -translate-x-full size-30 md:size-40 -z-10"
            ></BaseIcon>
            <p
            ...
            <BaseIcon name="Quote" size="40" class="absolute bottom-0 end-0 translate-x-full size-30 md:size-40 text-primary"></BaseIcon>
          </div>
